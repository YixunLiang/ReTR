...
class DtuFitSparse:
    def __init__(self, root_dir, split, scan_id, n_views=3,pair_filepath=None,
                 img_wh=[800, 600], clip_wh=[0, 0], original_img_wh=[1600, 1200],
                 N_rays=512, near=425, far=900, set=0, full_virtual_render=False,**kwargs):
    ...
    def scale_cam_info(self):
        ...
        for idx in range(len(self.all_images)):
            ...
            # new_near_fars.append([self.near, self.far])
        ...
        # new_near_fars = new_near_fars / self.scale_mat[0,0]
    ...
    def __getitem__(self, idx):
        ...
        sample['near_fars'] = self.scaled_near_fars[src_idx]  # (V, 2)
