...
if __name__ == '__main__':
    ...
    parser.add_argument('--scan_id', type=int, default=None)
    ...
    for scan in scans:
        if args.mode == 'mesh':
            ...
            data = os.path.join(args.outdir, "pc_result", "itermvs{:0>3}_l3.ply".format(scan))
            # data = os.path.join('/home/haohe/project/Reconformer/pc_result', "itermvs{:0>3}_l3.ply".format(scan))
            pbar = tqdm(total=8)
        ...
        if args.vis_error:
            ...
            write_vis_pcd(f'{args.outdir}/mesh/vis_{args.scan:03}_d2s.ply', data_down, data_color)
            stl_color = np.tile(B, (stl.shape[0], 1))
            stl_alpha = dist_s2d.clip(max=vis_dist) / vis_dist
            stl_color[ np.where(above)[0] ] = R * stl_alpha + W * (1-stl_alpha)
            stl_color[ np.where(above)[0][dist_s2d[:,0] >= max_dist] ] = G
            write_vis_pcd(f'{args.outdir}/mesh/vis_{args.scan:03}_s2d.ply', stl, stl_color)
...
#         fscore_3 = 2 * precision_3 * recall_3 / (precision_3 + recall_3 + 1e-6)
#         print(scan, mean_d2s, mean_s2d, over_all)
#         print(fscore_1, fscore_2, fscore_3)
#         print(precision_1, precision_2, precision_3)
#         print(recall_1, recall_2, recall_3)
#         mean_d2s_list.append(mean_d2s)
#         mean_s2d_list.append(mean_s2d)
#         over_all_list.append(over_all)

#         depth_mean_error_1.append(fscore_1)
#         depth_mean_error_2.append(fscore_2)
#         depth_mean_error_3.append(fscore_3)
#     print("final result")
#     print(mean(mean_d2s_list), mean(mean_s2d_list), mean(over_all_list))
#     print(mean(depth_mean_error_1), mean(depth_mean_error_2), mean(depth_mean_error_3))
