...
def save_tsdf(args, scan, save_mesh=True):
    ...
    for id in views:
        ...
        depth_im = data_tmp['depth']#*600
        # import pdb
        # pdb.set_trace()
        cam_intr = data_tmp['intrinsic']#[:3,:3]
        data_tmp['extrinsic'][:3, 3] = data_tmp['extrinsic'][:3, 3]#*600
    ...
    for id in views:
        ...
        depth_im = data_tmp['depth']#*600
        cam_intr = data_tmp['intrinsic']#[:3,:3]
        data_tmp['extrinsic'][:3, 3] = data_tmp['extrinsic'][:3, 3]#*600 #30 girl
        cam_pose = np.linalg.inv(data_tmp['extrinsic'])
        color_image = None
...
if __name__ == "__main__":
    ...
    # print('Not normal run.......')
    # scans = ['5a969eea91dfc339a9a3ad2c']#['5bcf979a6d5f586b95c258cd']#girl ['5947b62af1b45630bd0c2a02']
